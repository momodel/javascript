...
## 目录
  ...
  1. [Arrow Functions(箭头函数)](#arrow-functions)
  1. [Classes & Constructors](#classes--constructors)
  1. [Modules](#modules)
  1. [Iterators and Generators](#iterators-and-generators)
  1. [Variables(变量声明)](#variables)
  1. [Comparison Operators & Equality (运算符)](#comparison-operators--equality)
  1. [Control Statements](#control-statements)
  1. [Comments](#comments)
  1. [Whitespace](#whitespace)
  1. [Commas(逗号)](#commas)
  1. [Semicolons(封号)](#semicolons)
  1. [Type Casting & Coercion](#type-casting--coercion)
  1. [Naming Conventions (命名规范)](#naming-conventions)
  1. [Accessors (属性访问器)](#accessors)
  1. [Events](#events)
